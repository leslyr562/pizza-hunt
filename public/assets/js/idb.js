...
//The event won't run again unless we delete the database from the browser or we change the version number in the .open()
// method to a value of 2, indicating that our database needs an update.
